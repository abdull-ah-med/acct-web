        ...
        mainEntity: [
          {
            ...
            acceptedAnswer: {
              "@type": "Answer",
              text: "Run `npm install -g acct-sh` (or `pnpm add -g acct-sh`), then `acct init` with --id, --user, --email, --name, --bind, and optionally --import-gh. Add a shell hook with eval \"$(acct hook zsh)\".",
            },
          },
          {
            "@type": "Question",
